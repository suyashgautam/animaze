...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Search = function () {\n    function Search(query) {\n        _classCallCheck(this, Search);\n\n        this.query = query;\n    }\n\n    _createClass(Search, [{\n        key: 'getResults',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var res;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                _context.next = 2;\n                                return (0, _axios2.default)('https://api.jikan.moe/v3/search/anime?q=' + this.query + '&page=1');\n\n                            case 2:\n                                res = _context.sent;\n\n                                this.results = res.data.results;\n\n                            case 4:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this);\n            }));\n\n            function getResults() {\n                return _ref.apply(this, arguments);\n            }\n\n            return getResults;\n        }()\n    }, {\n        key: 'getTopResults',\n        value: function () {\n            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n                var res;\n                return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                    while (1) {\n                        switch (_context2.prev = _context2.next) {\n                            case 0:\n                                _context2.next = 2;\n                                return (0, _axios2.default)('https://api.jikan.moe/v3/top/anime/1');\n\n                            case 2:\n                                res = _context2.sent;\n\n                                this.top = res.data.top;\n\n                            case 4:\n                            case 'end':\n                                return _context2.stop();\n                        }\n                    }\n                }, _callee2, this);\n            }));\n\n            function getTopResults() {\n                return _ref2.apply(this, arguments);\n            }\n\n            return getTopResults;\n        }()\n    }, {\n        key: 'getGenreResults',\n        value: function () {\n            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(genre) {\n                var res;\n                return regeneratorRuntime.wrap(function _callee3$(_context3) {\n                    while (1) {\n                        switch (_context3.prev = _context3.next) {\n                            case 0:\n                                _context3.next = 2;\n                                return (0, _axios2.default)('https://api.jikan.moe/v3/genre/anime/' + genre + '/1');\n\n                            case 2:\n                                res = _context3.sent;\n\n                                this.genre = res.data.anime;\n\n                            case 4:\n                            case 'end':\n                                return _context3.stop();\n                        }\n                    }\n                }, _callee3, this);\n            }));\n\n            function getGenreResults(_x) {\n                return _ref3.apply(this, arguments);\n            }\n\n            return getGenreResults;\n        }()\n    }]);\n\n    return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/models/Search.js?");

/***/ }),

/***/ "./src/js/models/Show.js":
/*!*******************************!*\
  !*** ./src/js/models/Show.js ***!
  \*******************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.renderResults = exports.formatTitle = exports.removeResults = exports.transformResults = exports.highlightSelected = exports.clearButtons = exports.clearResults = exports.clearInput = exports.clearGenres = exports.getInput = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar getInput = exports.getInput = function getInput() {\n    return _base.elements.searchInput.value;\n};\n\nvar clearGenres = exports.clearGenres = function clearGenres() {\n    _base.elements.animeGenres.innerHTML = '';\n};\n\nvar clearInput = exports.clearInput = function clearInput() {\n    _base.elements.searchInput.value = '';\n};\n\nvar clearResults = exports.clearResults = function clearResults() {\n    _base.elements.resultsList.innerHTML = '';\n};\n\nvar clearButtons = exports.clearButtons = function clearButtons() {\n    _base.elements.resultsPagination.innerHTML = '';\n};\n\nvar highlightSelected = exports.highlightSelected = function highlightSelected(id) {\n    var resultsArr = Array.from(document.querySelectorAll('.results__link'));\n    resultsArr.forEach(function (el) {\n        el.classList.remove('results__link--active');\n    });\n    document.querySelector('.results__link[href*=\"#' + id + '\"]').classList.add('results__link--active');\n};\n\nvar transformResults = exports.transformResults = function transformResults() {\n    var isTransformed = _base.elements.results.classList.contains('transform');\n\n    if (!isTransformed) {\n        _base.elements.results.classList.add('transform');\n        _base.elements.results.classList.remove('remove2');\n        _base.elements.resultContainer.classList.add('remove');\n    }\n};\n\nvar removeResults = exports.removeResults = function removeResults() {\n    var isTransformed = _base.elements.results.classList.contains('transform');\n\n    if (isTransformed) {\n        _base.elements.results.classList.remove('transform');\n        _base.elements.results.classList.add('remove2');\n        _base.elements.resultContainer.classList.remove('remove');\n    }\n};\n\nvar formatTitle = exports.formatTitle = function formatTitle(title) {\n    var limit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 18;\n\n    var newTitle = [];\n    if (title.length > 20) {\n        title.split(' ').reduce(function (acc, cur) {\n            if (acc + cur.length <= limit) {\n                newTitle.push(cur);\n            }\n            return acc + cur.length;\n        }, 0);\n\n        return newTitle.join(' ') + ' ...';\n    }\n\n    return title;\n};\n\nvar renderShow = function renderShow(show) {\n    var markup = '\\n        <a class=\"results__link\" href=\"#' + show.mal_id + '\">\\n            <figure class=\"results__fig\">\\n                <img src=\"' + show.image_url + '\" alt=\"' + show.title + '\">\\n            </figure>\\n            <div class=\"results__data\">\\n                <h4 class=\"results__name\">' + formatTitle(show.title) + '</h4>\\n                <p class=\"results__type\">' + show.type + '</p>\\n            </div>\\n        </a>\\n    ';\n\n    _base.elements.resultsList.insertAdjacentHTML('beforeend', markup);\n};\n\nvar createButton = function createButton(type, page) {\n    return '\\n        <button class=\"btn-inline results__btn--' + type + '\" data-goto=\"' + (type === 'prev' ? page - 1 : page + 1) + '\">\\n            <svg>\\n                <use href=\"img/icons.svg#icon-triangle-' + (type === 'prev' ? 'left' : 'right') + '\"></use>\\n            </svg>\\n            <span>Page ' + (type === 'prev' ? page - 1 : page + 1) + '</span>\\n        </button>\\n';\n};\n\nvar renderButtons = function renderButtons(totalNumResults, page, resultsPerPage) {\n    var pages = Math.ceil(totalNumResults / resultsPerPage);\n    var button = void 0;\n\n    if (page === 1 && pages > 1) {\n        button = createButton('next', page);\n    } else if (page < pages) {\n        button = '\\n            ' + createButton('prev', page) + '\\n            ' + createButton('next', page) + '\\n        ';\n    } else if (page === pages && pages > 1) {\n        button = createButton('prev', page);\n    } else if (page === 1 && pages === 1) {\n        button = '';\n    }\n\n    _base.elements.resultsPagination.insertAdjacentHTML('afterbegin', button);\n};\n\nvar renderResults = exports.renderResults = function renderResults(shows) {\n    var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;\n    var resultsPerPage = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10;\n\n    var start = (page - 1) * resultsPerPage;\n    var end = page * resultsPerPage;\n    shows.slice(start, end).forEach(function (show) {\n        return renderShow(show);\n    });\n\n    // Render the buttons for pagination\n    renderButtons(shows.length, page, resultsPerPage);\n};\n\n//# sourceURL=webpack:///./src/js/views/searchView.js?");

/***/ }),

/***/ "./src/js/views/showView.js":
/*!**********************************!*\
  !*** ./src/js/views/showView.js ***!
  \**********************************/
/*! no static exports found */
